...
--Please adapt DATEDIFF parameters "startdate" and "enddate" to your query scenario
SELECT TOP 10 BasketID, CreatedDate
FROM dbo.Basket
WHERE DATEDIFF (MILLISECOND,'2017-08-09 11:00:20.9308732', CreatedDate) > 10
